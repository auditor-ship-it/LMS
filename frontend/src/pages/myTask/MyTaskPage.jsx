...
const CARD_DEFS = [
   ...
   * order. RENUMBERED 2026-09-18 (explicit request), then RENUMBERED BACK
   * 2026-09-22 (explicit request): the real internal stage 10 ("LR & Return
   * Transportation", owner Shivani) added 2026-09-18 between Transportation
   * and Gate In as "Stage 3" was removed from the workflow entirely 4 days
   * later — its card (olStage10) is gone, not relabelled, and every stage
   * after it in the sequence shifts back down by one. Order is now
   * 1 Intimation, 1A Approval, 2 Transportation, 3 Gate In, 4 Inspection,
   * 5 Final Billing, 6 KAM. Card ORDER fixed 2026-08-25 to match, and the two
   * retired stages (olStage2 "Lifting/Arrival", olStage4 "Quotation/Order" —
   * no active queue, no owner, permanently "All clear") dropped entirely
   * rather than shown as dead cards. Keys (olStage1..8) are untouched on the
